...
export default function PaginaDeVendas() {
  ...
  return (
    <div className="tema-papel fonte-humanista min-h-screen bg-[#f7f4ed] text-[#1c1917]">
      {/* Cabeçalho */}
      <header className="sticky top-0 z-40 border-b border-[#ded6c6] bg-[#f7f4ed]/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4">
          <div className="flex items-baseline gap-2">
            <span className="fonte-serifada text-lg font-semibold tracking-tight">Nota 1000</span>
            <span className="text-[11px] uppercase tracking-[0.18em] text-[#8a827a]">
              Avaliador de redação
            </span>
          </div>
          <button
            onClick={scrollToPricing}
            className="cursor-pointer border-b border-[#c0392b] pb-0.5 text-sm font-semibold text-[#c0392b] transition-colors hover:text-[#96271d]"
          >
            Ver planos
          </button>
        </div>
      ...
      <main>
        ...
        <section className="border-b border-[#ded6c6]">
          <div className="mx-auto max-w-5xl px-5 py-16 sm:py-24">
            <p className="mb-6 text-[11px] uppercase tracking-[0.2em] text-[#8a827a]">
            ...
            <h1 className="fonte-serifada max-w-3xl text-[2.1rem] font-semibold leading-[1.12] tracking-tight text-balance sm:text-[3.25rem]">
              ...
              <span className="fonte-manuscrita text-[#c0392b]">hoje mesmo</span>, com a nota de cada
              competência e os erros marcados no texto.
            </h1>

            <p className="mt-7 max-w-2xl text-[15px] leading-[1.75] text-[#57534e]">
            ...
            <div className="mt-9 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
              <button
                onClick={scrollToPricing}
                className="cursor-pointer bg-[#c0392b] px-7 py-3.5 text-sm font-bold text-[#fffdf8] transition-colors hover:bg-[#96271d]"
              >
        ...
        {/* Problema */}
        <section className="border-b border-[#ded6c6] bg-[#fffdf8]">
          <div className="mx-auto max-w-5xl px-5 py-16">
            <div className="grid gap-10 md:grid-cols-[1fr_1.4fr]">
              ...
              <div className="margem-caderno space-y-5 pl-6 text-[15px] leading-[1.75] text-[#57534e]">
                <p>
                ...
                <p>
                  ...
                  <span className="fonte-manuscrita text-[#c0392b]">
        ...
        <section className="border-b border-[#ded6c6]">
          <div className="mx-auto max-w-5xl px-5 py-16">
            <p className="mb-3 text-[11px] uppercase tracking-[0.2em] text-[#8a827a]">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr]">
              ...
              <div className="border border-[#ded6c6] bg-[#fffdf8] p-6 sm:p-8 shadow-[0_1px_0_rgba(28,25,23,0.06)]">
                <div className="bloco-pautado text-[15px] text-[#29487d]">
                  Nesse contexto, é evidente que{' '}
                  <span className="risco-corretor">os estudantes tem acesso</span>{' '}
                  <span className="fonte-manuscrita text-[#c0392b]">têm</span> desigual à
                  informação de qualidade, o que aprofunda a distância entre as escolas públicas e
                  particulares do país.
                </div>

                <div className="mt-6 border-t border-[#ded6c6] pt-5">
                  <p className="mb-1.5 text-[11px] uppercase tracking-[0.16em] text-[#c0392b]">
                  ...
                  <p className="text-[13px] leading-relaxed text-[#57534e]">
                    ...
                    diferencial obrigatório: <strong className="text-[#1c1917]">têm</strong>.
                  </p>
                </div>
              </div>

              {/* Placar de competências */}
              <div className="border border-[#ded6c6] bg-[#fffdf8] p-6 sm:p-8">
                <p className="mb-5 text-[11px] uppercase tracking-[0.16em] text-[#8a827a]">
                ...
                <ul className="space-y-3.5">
                  {[
                    ...
                    <li key={sigla as string} className="flex items-baseline gap-3">
                      <span className="fonte-serifada w-7 shrink-0 text-sm font-semibold text-[#1c1917]">
                        {sigla}
                      </span>
                      <span className="flex-1 text-[13px] text-[#57534e]">{nome}</span>
                ...
                <div className="mt-5 flex items-baseline justify-between border-t border-[#ded6c6] pt-5">
                  <span className="text-[11px] uppercase tracking-[0.16em] text-[#8a827a]">
                    Nota final
                  </span>
                  <span className="fonte-serifada text-3xl font-semibold tabular-nums text-[#c0392b]">
                    920
                  </span>
                </div>
              </div>
        ...
        <section className="border-b border-[#ded6c6] bg-[#fffdf8]">
          <div className="mx-auto max-w-5xl px-5 py-16">
            ...
            <ul className="divide-y divide-[#ded6c6] border-y border-[#ded6c6]">
              {BENEFICIOS.map((item) => (
                <li key={item.titulo} className="grid gap-2 py-6 md:grid-cols-[1fr_1.6fr] md:gap-10">
                  <h3 className="fonte-serifada text-lg font-semibold leading-snug text-[#1c1917]">
                    {item.titulo}
                  </h3>
                  <p className="text-[15px] leading-[1.75] text-[#57534e]">{item.texto}</p>
                </li>
              ))}
            </ul>
          </div>
            ...
            <ol className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {PASSOS.map((passo, i) => (
                <li key={passo.titulo} className="margem-caderno pl-5">
                  <span className="fonte-serifada block text-sm font-semibold text-[#c0392b]">
                    {String(i + 1).padStart(2, '0')}
                  </span>
                  <h3 className="fonte-serifada mt-1.5 text-base font-semibold leading-snug text-[#1c1917]">
                    {passo.titulo}
                  </h3>
                  <p className="mt-1.5 text-[13px] leading-relaxed text-[#57534e]">{passo.texto}</p>
                </li>
              ))}
            </ol>
          </div>
        ...
        {/* Planos */}
        <section id="oferta" className="border-b border-[#ded6c6] bg-[#fffdf8]">
          <div className="mx-auto max-w-5xl px-5 py-16">
            <h2 className="fonte-serifada text-2xl font-semibold tracking-tight sm:text-3xl">
              Planos de acesso
            </h2>
            <p className="mt-2 max-w-xl text-[15px] leading-relaxed text-[#57534e]">
              Correções ilimitadas em qualquer plano. Sem fidelidade e com garantia de sete dias.
            </p>

            {erroCheckout && (
              <p className="mt-5 border border-[#c0392b] bg-[#f6e4e1] px-4 py-2.5 text-[13px] text-[#96271d]">
                {erroCheckout}
              </p>
            )}
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {/* Mensal */}
              <div className="flex flex-col justify-between border border-[#ded6c6] bg-[#f7f4ed] p-7">
                <div>
                  <h3 className="fonte-serifada text-lg font-semibold">Mensal</h3>
                  <p className="mt-1 text-[13px] text-[#8a827a]">Para testar no seu ritmo.</p>
                  <p className="fonte-serifada mt-5 text-3xl font-semibold tabular-nums">
                    R$ 29,90
                  </p>
                  <p className="text-[12px] text-[#8a827a]">por mês</p>

                  <ul className="mt-6 space-y-2.5 border-t border-[#ded6c6] pt-5 text-[13px] text-[#57534e]">
                    <li className="flex gap-2">
                      <Check className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#c0392b]" />
                ...
                <button
                  ...
                  className="mt-7 flex cursor-pointer items-center justify-center border border-[#1c1917] px-5 py-3 text-[13px] font-bold text-[#1c1917] transition-colors hover:bg-[#1c1917] hover:text-[#fffdf8] disabled:opacity-50"
                >
              ...
              {/* Anual — destaque */}
              <div className="relative flex flex-col justify-between border-2 border-[#c0392b] bg-[#f7f4ed] p-7">
                <span className="fonte-manuscrita absolute -top-3.5 left-6 bg-[#f7f4ed] px-2 text-base text-[#c0392b]">
                  o mais escolhido
                </span>
                <div>
                  <h3 className="fonte-serifada text-lg font-semibold">Anual</h3>
                  <p className="mt-1 text-[13px] text-[#8a827a]">Acesso até a prova.</p>
                  <p className="fonte-serifada mt-5 text-3xl font-semibold tabular-nums">
                    R$ 147,00
                  </p>
                  <p className="text-[12px] text-[#8a827a]">ou 12x de R$ 14,90</p>
                ...
                <button
                  ...
                  disabled={planoCarregando !== null}
                  className="mt-7 flex cursor-pointer items-center justify-center bg-[#c0392b] px-5 py-3.5 text-[13px] font-bold text-[#fffdf8] transition-colors hover:bg-[#96271d] disabled:opacity-50"
                >
              ...
              <div className="flex flex-col justify-between border border-[#ded6c6] bg-[#f7f4ed] p-7">
                <div>
                  ...
                  <p className="mt-1 text-[13px] text-[#8a827a]">Para a reta de preparação.</p>
                  <p className="fonte-serifada mt-5 text-3xl font-semibold tabular-nums">
                    R$ 89,00
                  </p>
                  <p className="text-[12px] text-[#8a827a]">pagamento único, seis meses</p>
            ...
            <div className="mt-12 flex flex-col items-start gap-6 border-t border-[#ded6c6] pt-10 sm:flex-row sm:items-center">
              ...
              <p className="max-w-xl text-[14px] leading-relaxed text-[#57534e]">
        ...
        <section className="border-b border-[#ded6c6]">
          <div className="mx-auto max-w-3xl px-5 py-16">
            ...
            <div className="divide-y divide-[#ded6c6] border-y border-[#ded6c6]">
              {FAQ.map((item, idx) => (
                <div key={item.q}>
                  <button
                  ...
                  >
                    <span className="fonte-serifada text-[15px] font-semibold text-[#1c1917]">
                      {item.q}
                    </span>
                    <ChevronDown
                      className={`h-4 w-4 shrink-0 text-[#8a827a] transition-transform ${
                        openFaq === idx ? 'rotate-180' : ''
                      }`}
                    />
                  </button>
                  {openFaq === idx && (
                    <p className="pb-5 pr-10 text-[14px] leading-[1.75] text-[#57534e]">{item.a}</p>
                  )}
                </div>
              ))}
            </div>
            ...
            <div className="mt-12 text-center">
              <button
                onClick={scrollToPricing}
                className="cursor-pointer bg-[#c0392b] px-8 py-3.5 text-sm font-bold text-[#fffdf8] transition-colors hover:bg-[#96271d]"
              >
                Ver planos de acesso
              </button>
            </div>
      ...
      <footer className="mx-auto max-w-5xl px-5 py-10">
        <div className="flex flex-col justify-between gap-3 text-[12px] text-[#8a827a] sm:flex-row">
          <span className="fonte-serifada text-[#57534e]">
