---
title: Persona & Dores Críticas dos Vestibulandos
tags:
  - persona
  - dores
  - vestibulando
...
graph LR
    subgraph Dores
        D1[Demora de 15 dias no cursinho]
        D2[Insegurança nas 5 Competências]
        D3[Falta de Repertório Sociocultural]
        D4[Medo de perder o ano no SISU]
    end
    subgraph Solução Nota 1000 AI
        S1[Correção instantânea em menos de 10s]
        S2[Detalhamento C1-C5 e contagem da C5]
        S3[Versão Nota 1000 gerada com repertório Bauman/Habermas/Kant]
        S4[Treino diário ilimitado com acompanhamento em gráficos]
    end
    D1 --> S1
    D2 --> S2
    D3 --> S3
