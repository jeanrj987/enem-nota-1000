...
- **Exceção para quem já comprou** (ADR 047): com plano ativo, as âncoras de venda dão lugar aos `DESTINOS_DO_APP` (Dashboard, Nova Redação, Histórico), com drawer no celular, e o CTA deixa de dizer "de graça". Sem conta ou sem plano **nada muda** — a navegação pobre da landing é decisão de funil, não descuido, e é o caso que os testes guardam.
