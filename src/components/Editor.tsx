...
export function Editor({ initialTema = '' }: EditorProps) {
  ...
  const editorJSX = (
    <div className={`space-y-6 ${zenMode ? 'fixed inset-0 z-[99999] bg-[#02040a] p-4 sm:p-8 overflow-y-auto' : ''}`}>
      ...
      {/* Modal de Cadastro Obrigatório para Teste Demo */}
      {showAuthGateModal && (
        <div className="fixed inset-0 z-[100000] bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
          <div className="tech-card max-w-md w-full p-6 sm:p-8 rounded-3xl border border-cyan-500/40 text-left space-y-5 shadow-2xl animate-fade-in relative">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-slate-300 font-sans">
                Para salvar seu texto e gerar o relatório oficial de correção, conecte-se com 1 clique:
              </p>
            </div>
            ...
            <button
              type="button"
              onClick={() => loginComGoogleSupabase('/nova-redacao')}
              className="w-full py-2.5 px-3 rounded-xl bg-white text-slate-900 font-heading font-extrabold text-xs flex items-center justify-center gap-2.5 hover:bg-slate-100 transition-all shadow-md cursor-pointer border border-slate-200 active:scale-[0.98]"
            >
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="bg-[#030612] px-2.5 text-[10px] uppercase font-mono text-slate-400 shrink-0">
                ou com e-mail
              </span>
              <div className="border-t border-white/[0.08] w-full" />
            </div>
            ...
            <form onSubmit={handleQuickRegister} className="space-y-3.5">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#030612] border border-cyan-500/30 rounded-xl pl-9 pr-3 py-2 text-xs text-white focus:outline-none focus:border-cyan-400"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="btn-cyber-primary w-full py-3.5 rounded-xl font-heading font-black text-xs flex items-center justify-center gap-2 shadow-lg cursor-pointer"
              >
                {authLoading ? (
                  ...
                  <>
                    ...
                    <span>CRIAR CONTA E CORRIGIR AGORA</span>
                  </>
                )}
              </button>
            </form>
