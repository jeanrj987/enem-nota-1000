...
export function ModalCarregamento({ loadingTips, loadingStep }: ModalCarregamentoProps) {
  return (
    <div className="fixed inset-0 z-50 bg-papel/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="max-w-md w-full glass-panel p-8 rounded-xl border border-azul text-center space-y-6 shadow-2xl">
        <div className="w-16 h-16 rounded-xl bg-azul-claro border border-azul flex items-center justify-center mx-auto shadow-inner">
          <Sparkles className="w-8 h-8 text-azul animate-pulse" />
        </div>
        ...
        <div className="w-full bg-folha-2 rounded-full h-2 overflow-hidden">
          <div
            className="bg-azul hover:brightness-110 h-full transition-all duration-500"
