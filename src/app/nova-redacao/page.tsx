        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="glass-panel p-6 rounded-sm border border-regua space-y-4">
            ...
            <ul className="space-y-3 text-xs text-tinta-suave">
              <li className="flex items-start gap-2.5 p-2.5 rounded-sm bg-folha/60 border border-regua">
          ...
          <div className="glass-panel p-6 rounded-sm border border-vermelho bg-vermelho hover:bg-vermelho-escuro to-folha space-y-3">
            <div className="flex items-center gap-2 text-xs font-bold text-vermelho uppercase tracking-wider">
