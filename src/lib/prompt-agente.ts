...
- 80: Desenvolvimento insuficiente, texto em monobloco ou tangenciamento do tema.
...
{
  "nota_geral": number (soma exata das 5 notas individuais, de 0 a 1000, múltiplo de 40),
  "competencias": [
    {
      "numero": 1,
